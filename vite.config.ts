...
export default defineConfig({
 plugins: [react(), tailwindcss(), VitePWA({
  ...
  includeAssets: ['icon.svg','icon-192.png','icon-512.png','securetrack-logo.png'],
  ...
  workbox: { cleanupOutdatedCaches: true, skipWaiting: true, clientsClaim: true, maximumFileSizeToCacheInBytes: 4 * 1024 * 1024, globPatterns: ['**/*.{js,css,html,svg,png,woff2,wasm}'], navigateFallback: 'index.html', runtimeCaching: [] },
