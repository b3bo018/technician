...
export const JOB_TYPES = ['new_installation', 'device_removal', 'sim_change', 'sim_device_change', 'inspection'] as const;
...
export const jobLabel = (job: JobType) => ({ new_installation: 'New installation', sim_change: 'SIM change', sim_device_change: 'SIM and device change', device_removal: 'Removal', inspection: 'Inspection' }[job]);
