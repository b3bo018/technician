...
export default function App() {
 ...
 const [workSessions,setWorkSessions]=useState<WorkSession[]>([]);const [workBreaks,setWorkBreaks]=useState<WorkBreak[]>([]);const [stockAlerts,setStockAlerts]=useState<StockAlertSettings>({threshold:2});
